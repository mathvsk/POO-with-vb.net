...
#Region "PROPRIEDADES"
        ...
        'Da pra encapsular automaticamente no vb.net (Não precisa de todo aquele código que tem na classe da conta corrente) caso não tenha regras de negócios em suas classes/métodos, da pra fazer desse jeito resumido
        Public Property Nome As String

        'CPF tem uma regra de negócio, impossibilitando a declaração dessa maneira
        ...
        Public Property CPF As String
            ...
            End Get
            Set(value As String)
                'Regra de negócio para validar o cpf
